...
public class Signupone extends JFrame implements ActionListener{
    ...
    JDateChooser dateChooser;
     ...
     Signupone()  {
         ...
         JLabel dop=new JLabel("Date Of Birth: " );
         dop.setFont(new Font("Raleway",Font.BOLD,20));
         dop.setBounds (100,240,200,30);
         add(dop);

          dateChooser=new JDateChooser();                   // with the help of calender jar file
       ...
       female=new JRadioButton("Female");         //Radio button for female
        ...
        female.setBackground(Color.WHITE);
         ...
         ButtonGroup gendergroup=new ButtonGroup();     //Select only one option either male or female
        ...
        married=new JRadioButton("Married");     //Radio button for married
         ...
         add(married);
          ...
          unmarried=new JRadioButton("Unmarried");         //Radio botton for unmarried
         unmarried.setBounds(450,390,100,30);
         unmarried.setBackground(Color.WHITE);
         add(unmarried);

         other=new JRadioButton("Other");         //Radio botton for other
         other.setBounds(630,390,100,30);
         other.setBackground(Color.WHITE);
         add(other);


         ButtonGroup maritalgroup=new ButtonGroup();     //Select only one option either married or unmarried
       ...
       addressTextField=new JTextField();
         ...
         add(pincode);
          ...
          pincodeTextField=new JTextField();                            //boxes textfield
